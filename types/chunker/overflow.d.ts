...
declare class Overflow {
     ...
     */
    constructor(node: Node, offset?: number, overflowHeight?: number, range?: Range, topLevel?: boolean);
    /**
     ...
     */
    equals(otherOffset?: Partial<Pick<Overflow, "node" | "offset">> | null): boolean;
}
