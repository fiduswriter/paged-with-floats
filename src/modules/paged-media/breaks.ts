...
class Breaks extends Handler {
	 ...
	 */
	processBreaks(parsed: DocumentFragment, breaks: BreaksMap) {
		for (let b in breaks) {
	 ...
	 */
	addBreakAttributes(pageElement: HTMLElement, page: PageLike) {
		let before = pageElement.querySelector<HTMLElement>("[data-break-before]");
		let after = pageElement.querySelector<HTMLElement>("[data-break-after]");
		let previousBreakAfter = pageElement.querySelector<HTMLElement>(
	...
	afterPageLayout(pageElement: HTMLElement, page: PageLike) {
